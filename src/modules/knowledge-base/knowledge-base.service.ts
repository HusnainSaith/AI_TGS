...
export class KnowledgeBaseService {
  ...
  private versionResponse(v: DocumentVersion) {
    return {
      ...
      malwareScannerProvider: v.malwareScannerProvider,
      malwareScannedAt: v.malwareScannedAt,
      malwareScanMetadata: v.malwareScanMetadata,
      malwareErrorCode: v.malwareErrorCode,
